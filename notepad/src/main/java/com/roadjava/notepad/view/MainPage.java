...
import com.roadjava.notepad.handler.MenuHandler;
import com.roadjava.notepad.handler.ContAreaHandler;
...
public class MainPage extends JFrame {
    ...
    private void createViewMenu() {
        ...
        defaultFontSizeMenuItem.setMnemonic(KeyEvent.VK_O);
        ...
        statusMenuItem.setMnemonic(KeyEvent.VK_O);
    ...
    private void createFormatMenu() {
        ...
        autoBreakLineMenuItem.setMnemonic(KeyEvent.VK_O);
        ...
        fontColorMenuItem.setActionCommand("fontMenuItem");
    ...
    private void createEditMenu() {
        ...
        JMenuItem copyMenuItem = new JMenuItem("拷贝（C）");
        ...
        JMenuItem datetimeMenuItem = new JMenuItem("时间日期（D）");
    ...
    private void createFileMenu() {
        ...
        saveMenuItem.setMnemonic(KeyEvent.VK_O);
        ...
        JMenuItem exitMenuItem = new JMenuItem("退出（S）");
    ...
    public void setContSaved(boolean contSaved) {
        this.contSaved = contSaved;
    }
